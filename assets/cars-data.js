...
window.CARS = {
  'aston-martin-db9': {
    ...
    tag: 'Grand Tourer',
    price: '70 000 €',
    image: 'assets/car-db9-6.jpg',
    images: ['assets/car-db9-6.jpg', 'assets/car-db9-7.jpg', 'assets/car-db9-8.jpg', 'assets/car-db9-9.jpg', 'assets/car-db9-10.jpg'],
    imageViews: ['front-3q', 'side', 'rear-3q', 'interior-front', 'detail'],
    photoStyle: true,
    special: [
  ...
  'pontiac-fiero': {
    ...
    heroSpecs: [
      { label: 'Positsioon', value: 'Mid-engine' },
      { label: 'Mootor',   value: 'R4' },
  ...
  'jaguar-xjs-v12-green': {
    ...
    photoStyle: true,
    special: [
      'Stiilne V12 mootoriga Briti GT-auto koos vääriliste sõiduomadustega. British Racing Green ja valge nahkinterjöör loovad suurepärase koosluse. V12 mootor ja mugav vedrustus on meeldivaks kaaslaseks igal road tripil.',
    ],
    caution: [
      'V12 mootoriga kaasnevad alati keskmisest suuremad kulud. Seisukorda iseloomustab hästi "sõidan, naudin, kasutan" stiil ja sobib hästi omanikule, kes on valmis autosse hoolt ja armastust investeerima. Mootor vajab remonti, surve sees.',
    ],
    specs: [
